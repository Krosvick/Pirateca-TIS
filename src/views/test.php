        ...
        <?php foreach ($movies as $movie): ?>
            <div class="max-w-sm rounded overflow-hidden shadow-lg m-5 flex flex-col">
                <a href="/movie/<?= $movie->get_id() ?>">
                    <img class="w-full border-4 border-t-purple-600 border-l-purple-600 border-r-purple-800 border-b-purple-800" src="<?= $movie->get_poster_path() ? "https://image.tmdb.org/t/p/w500" . $movie->get_poster_path() : '/views/images/PLACEHOLDER.png' ?>" alt="Movie page" loading="lazy">
                </a>
