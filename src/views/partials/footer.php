<footer class="w-full py-5 px-4 sm:px-6 lg:px-8 mx-auto bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 mt-5">
  <!-- Grid -->
  <div class="text-center">
    <div>
      <a class="flex-none text-xl font-semibold text-black dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">Pirateca</a>
    </div>
    <!-- End Col -->
