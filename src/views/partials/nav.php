    ...
    <nav class="bg-white shadow">
        <div class="max-w-screen-xl mx-auto px-4 py-2 flex items-center justify-between">
            ...
            <div>
                ...
                <button class="text-purple-800 hover:text-gray-900 hover:bg-gray-100 px-4 py-2 rounded transition duration-300" onclick="window.location.href='/'">Home</button>
                ...
                <button class="text-purple-800 hover:text-gray-900 hover:bg-gray-100 px-4 py-2 rounded transition duration-300" onclick="window.location.href='/profile/liked_movies'">Liked</button>
