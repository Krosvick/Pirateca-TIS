        ...
        <div class="w-full p-6 m-auto bg-white rounded-md shadow-md ring-2 ring-gray-800/50 lg:max-w-lg">
            ...
            <form class="space-y-4" action="/register" method="POST">
                <div>
                  ...
                  <input type="text" id="username" name="username" class="bg-white border border-gray-600 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required>
                ...
                <div>
                  ...
                  <input type="password" id="password" name="password" class="bg-white border border-gray-600 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-blue-500 block w-full p-2.5" required>
                ...
                <div>
                  ...
                  <input type="password" id="password" name="confirm_password" class="bg-white border border-gray-600 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-blue-500 block w-full p-2." required>
                </div>
                <div>
                    <p>&nbsp</p>
                    <hr>
